    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if($by=="your_self"){
            ...
            if (isset($_POST['submit_button'])){
                ...
                $query_run1="UPDATE `event_".$event_id."_pro_don` SET content='$content1',note='$note' where by_person='".$by_person."' and to_person='".$to."'";
            }
        }else{
            $by_org=$by;
            if (isset($_POST['submit_button'])){
                ...
                $query_run1="UPDATE `event_".$event_id."_pro_don` SET content='$content1',note='$note' where by_org='".$by_org."' and to_person='".$to."'";
