    ...
    <body>
            ...
            <div>
                <div id="menubar">
                    ...
                    <a href='/organization/org_list.php' class='menubar_button_container menubar_buttons_cont'><div class="menubar_buttons" name='menubar_buttons'  value=6><div class="menu_icon_tooltip"><i class='fas fa-users menu_icon menu_bar_btn_6'></i><span class="menu_icon_tooltiptext">Organization</span></div></div><div id=menubar_org_container></div></a>
